    ...
    (RoundSlider.prototype = {
      ...
      _tooltipEditable: function () {
        ...
        n &&
          i.showTooltip &&
          (i.editableTooltip
            ? (n.addClass("edit"), (t = "_bind"))
            : (n.removeClass("edit"), (t = "_unbind")),
          this[t](n, "click", this._editTooltip));
      },
      _editTooltip: function () {
        ...
        n.hasClass("edit") &&
          !this._isReadOnly &&
          ((i = parseFloat(n.css("border-left-width")) * 2),
          (t = this.input =
            this.$createElement("input.rs-input rs-tooltip-text").css({
              height: n.outerHeight() - i,
              width: n.outerWidth() - i,
            })),
          n.html(t).removeClass("edit").addClass("hover"),
      ...
      _setHandleShape: function () {
        var t = this.options.handleShape,
          n = this._handles();
        n.removeClass("rs-handle-dot rs-handle-square"),
          t == "dot"
            ? n.addClass("rs-handle-dot")
            : t == "square"
            ? n.addClass("rs-handle-square")
      ...
      _handleDefaults: function () {
        ...
        return { angle: this._valueToAngle(n), value: n };
      },
      _handles: function () {
      ...
      _updateARIA: function (n) {
        ...
        this.bar.children().attr({ "aria-valuenow": n }),
          i.sliderType == "range"
            ? ((t = this._handles()),
              t.eq(0).attr({ "aria-valuemin": r }),
              t.eq(1).attr({ "aria-valuemax": u }),
              this._active == 1
                ? t.eq(1).attr({ "aria-valuemin": n })
                : t.eq(0).attr({ "aria-valuemax": n }))
            : this.bar
                .children()
                .attr({ "aria-valuemin": r, "aria-valuemax": u });
      },
      _checkKO: function () {
      ...
      _processStepByValue: function (n) {
        ...
        return (
          ...
          (h = (n - o) % i),
          (t = n - h),
          (r = this._limitValue(t + i)),
          (u = this._limitValue(t - i)),
          (f = s
            ? n <= t
              ? t - n < n - r
                ? t
      ...
      _getTooltipPos: function () {
        ...
        if (n == "full" || n == "pie" || n.indexOf("custom") === 0)
          return { "margin-top": -i / 2, "margin-left": -r / 2 };
        if (n.indexOf("half") != -1) {
          switch (n) {
            case "half-top":
            case "half-bottom":
      ...
      _updateStartEnd: function () {
        ...
        n != "full" &&
          ...
          n == "quarter-top-left" || n == "half-top"
            ...
            ? (t = 180)
            : (n == "quarter-bottom-left" || n == "half-left") && (t = 270),
      ...
      setValue: function (n, t) {
        ...
        this.isNumber(n) &&
          (this.isNumber(t) &&
            ((i = this.options.sliderType),
            i == "range"
              ? ((r = parseFloat(t)),
                (u = parseFloat(n)),
                r == 1
                  ? (n = u + "," + this._handle2.value)
                  : r == 2 && (n = this._handle1.value + "," + u))
              : i == "default" && (this._active = t)),
          this._set("value", n));
      },
      disable: function () {
